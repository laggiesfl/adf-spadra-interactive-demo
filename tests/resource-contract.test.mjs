...
test('rejects missing required resource metadata', () => {
  const result = validateResourceMetadata({ title:'', summary:'short', country:'Ghana', topic:'Policy', language:'English', accessibility:'' });
...
test('maps only safe published Airtable fields', () => {
  const mapped=mapAirtableRecord({id:'rec123',fields:{Title:'Guide',Summary:'Accessible summary for everyone.',Country:'Ghana',Topic:'Policy',Language:'English','Accessibility notes':'Tagged PDF',Attachment:[{id:'att1',filename:'guide.pdf',type:'application/pdf',size:1200,url:'https://airtable.example/private'}],'Publication status':'Published','Updated at':'2026-08-04T12:00:00Z',Secret:'never'}});
  assert.deepEqual(mapped,{id:'rec123',title:'Guide',summary:'Accessible summary for everyone.',country:'Ghana',topic:'Policy',language:'English',format:'PDF',accessibility:'Tagged PDF',fileName:'guide.pdf',fileSize:1200,downloadUrl:'/api/resources/rec123/download',publicationStatus:'Published',updated:'4 Aug 2026',demonstration:true,persistent:true});
