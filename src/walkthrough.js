export const WALKTHROUGH_STEPS = Object.freeze([
  { title: 'SPADRA at a glance', prompt: 'Introduce the shared hub and its four participating countries.', targetId: 'overview' },
  { title: 'Country progress', prompt: 'Show how milestones and progress can be explored without relying on colour alone.', targetId: 'countries' },
  ...
  { title: 'Knowledge sharing', prompt: 'Search accessible resources by country, topic and language.', targetId: 'knowledge' },
